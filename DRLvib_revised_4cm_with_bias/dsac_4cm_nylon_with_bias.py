...
from utils.ReplayBuffer import ReplayBufferBias
...
def main():
    ...
    replay_buffer = ReplayBufferBias(buffer_size=BUFFER_SIZE, batch_size=BATCH_SIZE, device=device)
