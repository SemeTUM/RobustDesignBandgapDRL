...
class VibEnv3D():
    ...
    def comsolEnv(self,path1):
        ...
        model.component("comp1").geom("geom1").feature("r2").set("size", ["0.05", "0.05"]);
        model.component("comp1").geom("geom1").feature("r2").set("pos", ["0", "0"]);
        model.component("comp1").geom("geom1").create("arr1", "Array");
        model.component("comp1").geom("geom1").feature("arr1").set("fullsize", ["30", "30"]);
        model.component("comp1").geom("geom1").feature("arr1").set("displ", ["0.05", "0.05"]);
        model.component("comp1").geom("geom1").feature("arr1").selection("input").set("r2");
        model.component("comp1").geom("geom1").create("r3", "Rectangle");
        model.component("comp1").geom("geom1").feature("r3").set("size", ["0.05", "0.05"]);
        model.component("comp1").geom("geom1").feature("r3").set("pos", ["1.5", "0"]);
        model.component("comp1").geom("geom1").create("arr2", "Array");
        model.component("comp1").geom("geom1").feature("arr2").set("fullsize", ["30", "30"]);
        model.component("comp1").geom("geom1").feature("arr2").set("displ", ["0.05", "0.05"]);
        model.component("comp1").geom("geom1").feature("arr2").selection("input").set("r3");
        model.component("comp1").geom("geom1").create("r4", "Rectangle");
        model.component("comp1").geom("geom1").feature("r4").set("size", ["0.05", "0.05"]);
        model.component("comp1").geom("geom1").feature("r4").set("pos", ["0", "1.5"]);
        model.component("comp1").geom("geom1").create("arr3", "Array");
        model.component("comp1").geom("geom1").feature("arr3").set("fullsize", ["30", "30"]);
        model.component("comp1").geom("geom1").feature("arr3").set("displ", ["0.05", "0.05"]);
        model.component("comp1").geom("geom1").feature("arr3").selection("input").set("r4");
        model.component("comp1").geom("geom1").create("r5", "Rectangle");
        model.component("comp1").geom("geom1").feature("r5").set("size", ["0.05", "0.05"]);
        model.component("comp1").geom("geom1").feature("r5").set("pos", ["1.5", "1.5"]);
        model.component("comp1").geom("geom1").create("arr4", "Array");
        model.component("comp1").geom("geom1").feature("arr4").set("fullsize", ["30", "30"]);
        model.component("comp1").geom("geom1").feature("arr4").set("displ", ["0.05", "0.05"]);
