...
class VibEnv3D():
    ...
    def comsolEnv(self,path1):
        ...
        model.component("comp1").geom("geom1").feature("r1").set("size", ["4", "4"]);
        ...
        model.component("comp1").geom("geom1").feature("arr1").set("fullsize", ["20", "20"]);
        ...
        model.component("comp1").geom("geom1").feature("r3").set("pos", ["2", "0"]);
        model.component("comp1").geom("geom1").create("arr2", "Array");
        model.component("comp1").geom("geom1").feature("arr2").set("fullsize", ["20", "20"]);
        ...
        model.component("comp1").geom("geom1").feature("r4").set("pos", ["0", "2"]);
        model.component("comp1").geom("geom1").create("arr3", "Array");
        model.component("comp1").geom("geom1").feature("arr3").set("fullsize", ["20", "20"]);
        ...
        model.component("comp1").geom("geom1").feature("r5").set("pos", ["2", "2"]);
        model.component("comp1").geom("geom1").create("arr4", "Array");
        model.component("comp1").geom("geom1").feature("arr4").set("fullsize", ["20", "20"]);
        ...
        model.component("comp1").selection("box1").set("ymax", "4.01");
        model.component("comp1").selection("box1").set("condition", "inside");
        model.component("comp1").selection("box2").label("x_right");
        model.component("comp1").selection("box2").set("xmin", "3.99");
        model.component("comp1").selection("box2").set("xmax", "4.01");
        model.component("comp1").selection("box2").set("ymin", "-0.001");
        model.component("comp1").selection("box2").set("ymax", "4.01");
        ...
        model.component("comp1").selection("box3").set("xmax", "4.01");
        model.component("comp1").selection("box3").set("ymin", "3.99");
        model.component("comp1").selection("box3").set("ymax", "4.01");
        ...
        model.component("comp1").selection("box4").set("xmax", "4.01");
...
#        model.component("comp1").view("view1").axis().set("ymax", 4.63471794128418);
        ...
        model.component("comp1").physics("solid").feature("lemm1").set("E", "0.38e9");
        model.component("comp1").physics("solid").feature("lemm1").set("nu_mat", "userdef");
        model.component("comp1").physics("solid").feature("lemm1").set("nu", "0.35");
        model.component("comp1").physics("solid").feature("lemm1").set("rho_mat", "userdef");
        model.component("comp1").physics("solid").feature("lemm1").set("rho", "1410");
        ...
        #model.save('CHECKINGMODEL4cm.mph')
        client.remove('Model')
        return table_str

    def find_gap(self, f_low, f_high, bndgp):
        #for target frequency optimization for a given lower and higher frequency ranges
    ...
    def getValue(self,bndgp):
        ...
        for i in range(19):
            #bng = bng[i]* 343/0.04 #For surrogate modelling
           # J = 2*((min(bng[i+1])**2 - max(bng[i])**2)/(min(bng[i+1])**2 + max(bng[i])**2))
            J = (min(bng[:,i+1]) - max(bng[:,i]))/1000
            local_reward = 10*J if J >0 else J
            Obj1.append(local_reward)
        reward = np.sum(np.real(Obj1))/10
        reward= np.clip(reward, -10, 100)
